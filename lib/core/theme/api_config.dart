...
class ApiConfig {
  ...
  /// Production default: https://api.andikanugra.my.id
  ...
  static const String usersRegionPreferences =
      '$apiVersion/users/region-preferences';
  ...
  static const String usersFavoriteServices =
      '$apiVersion/users/favorite-services';
  ...
  static String hospitalPolyclinics(int id) =>
      '$apiVersion/hospitals/$id/polyclinics';
  static String polyclinicDoctors(int id) =>
      '$apiVersion/polyclinics/$id/doctors';
  ...
  static String sapaProgramDetail(int id) =>
      '$apiVersion/sapa-bansos/programs/$id';
  static const String sapaMyApplications =
      '$apiVersion/sapa-bansos/my-applications';
  static String sapaApplicationDetail(int id) =>
      '$apiVersion/sapa-bansos/applications/$id';
  ...
  static String islamicCenterDetail(int id) =>
      '$apiVersion/islamic-centers/$id';
  static String islamicCenterPrayerTimes(int id) =>
      '$apiVersion/islamic-centers/$id/prayer-times';
  static String islamicCenterEvents(int id) =>
      '$apiVersion/islamic-centers/$id/events';
  ...
  static String transJatimRouteDetail(int id) =>
      '$apiVersion/transjatim/routes/$id';
  static const String transJatimSchedulesSearch =
      '$apiVersion/transjatim/schedules/search';
  static String transJatimRouteSchedules(int id) =>
      '$apiVersion/transjatim/routes/$id/schedules';
  static String transJatimTracking(int scheduleId) =>
      '$apiVersion/transjatim/tracking/$scheduleId';

  // Emergency contacts
  static const String emergencyRegions = '$apiVersion/emergency/regions';
  static String emergencyContacts({String? region}) =>
      region == null || region.isEmpty
      ? '$apiVersion/emergency/contacts'
      : '$apiVersion/emergency/contacts?region=$region';
