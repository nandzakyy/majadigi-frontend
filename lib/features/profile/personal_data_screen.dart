...
class _PersonalDataScreenState extends State<PersonalDataScreen> {
  final TextEditingController nameController = TextEditingController(text: "Lois Becket");
  final TextEditingController nikController = TextEditingController(text: "123456789885758");
  final TextEditingController emailController = TextEditingController(text: "Loisbecket@gmail.com");
  final TextEditingController phoneController = TextEditingController(text: "085745986777");
  final TextEditingController addressController = TextEditingController(text: "Jl. Tugu No.1, Kiduldalem, Kec. Klojen, Kota Malang, Jawa Timur 65119.");
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _buildTextField("Tanggal Lahir", TextEditingController(text: "29/02/2001"), false, readOnly: true),
                ),
              ],
            ),
            const SizedBox(height: 16),
