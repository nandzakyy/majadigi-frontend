...
class AboutJatimScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const CustomWaveHeader(title: 'Tentang Jawa Timur'),
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Terletak di ujung timur Pulau Jawa, Indonesia, Provinsi Jawa Timur secara administratif terdiri dari 29 kabupaten, dan 9 kota. Melansir laman BPS Tahun 2023, luas wilayah Jawa Timur sekitar 48.036,84 km². Jawa Timur menjadi wilayah dengan jumlah penduduk terbanyak di Indonesia, populasinya lebih dari 40 jiwa. Jawa Timur memiliki peran strategis dalam lanskap nasional dari berbagai aspek seperti demografi, ekonomi, industri, infrastruktur, politik, dan budaya.\n\n'
